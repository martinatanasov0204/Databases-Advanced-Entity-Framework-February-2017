namespace _01_book_shop_system_DB.Migrations
{
    ...
    using System.IO;
    using _01_book_shop_system_DB.Models;
    using System.Data.Entity.Migrations;
    using System.Linq;

    internal sealed class Configuration : DbMigrationsConfiguration<_01_book_shop_system_DB.BookSystemContext>
    {
        public Configuration()
        {
            AutomaticMigrationsEnabled = true;
            AutomaticMigrationDataLossAllowed = true;
            ContextKey = "_01_book_shop_system_DB.BookSystemContext";
        }

        protected override void Seed(_01_book_shop_system_DB.BookSystemContext context)
        {
            SeedAuthors(context);
            SeedBooks(context);
            SeedCategories(context);
        }
        private static void SeedAuthors(BookSystemContext context)
        {
        ...
        private static void SeedBooks(BookSystemContext context)
        {
        ...
        private static void SeedCategories(BookSystemContext context)
        {
